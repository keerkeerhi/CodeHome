<template>
    <div class="pageContent">
      <svg xmlns="http://www.w3.org/2000/svg"
        ...
        <g id="mysvg">
          <circle cx="300" cy="300" r="300" stroke="black" fill="#FF6600" ></circle>
          <line class="line" v-for="i in number"  x1="300" y1="300" x2="0" y2="300" stroke="black" ></line>
